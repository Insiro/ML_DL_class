...
class DepthWiseConv2d(nn.Module):
    def __init__(self, in_channel, kernel_size, **kwargs) -> None:
        super().__init__()
        self.conv = nn.Conv2d(
            in_channel,
            in_channel,
...
class BasicConv2d(nn.Module):
    def __init__(self, in_channels, out_channel, kernel_size, **kwargs):
        super().__init__()
        self.conv = nn.Conv2d(in_channels, out_channel, kernel_size, **kwargs)
...
class DepthSeperabelConv2d(nn.Module):
    def __init__(self, in_channel, out_channel, kernel_size, **kwargs):
        super().__init__()
        self.depthwise = DepthWiseConv2d(in_channel, kernel_size, **kwargs)
        self.pointwise = PointWiseConv2d(in_channel, out_channel)
...
class MobileNet(nn.Module):
    ...
    def __init__(self, width_multiplier=1, num_classes=100):
        super().__init__()
